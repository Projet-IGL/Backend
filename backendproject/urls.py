...
from backendapp.views import creer_patient ,modifier_statut_ordonnance, creer_ordonnance ,creer_bilan_biologique, creer_bilan_radiologique, verifier_patient_par_nss, rechercher_dpi_par_nss, get_consultations_by_nss,get_soins_by_nss, check_consultation_existence, check_consultation_existence_bilan_biologique, recuperer_bilan_biologique, recuperer_bilan_radiologique, recuperer_ordonnance, get_ordonnance_by_nss_and_consultation
...
urlpatterns = [
    ...
    path('api/ordonnances/<int:ordonnance_id>/statut/', modifier_statut_ordonnance, name='modifier_statut_ordonnance'),
]

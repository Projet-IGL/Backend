...
SECRET_KEY = 'django-insecure-*%yvvztz#zhl)b^y4e%7f12euo4g72yl*$7ys_2#km3fh9o%)z'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'manel',    # Your MySQL password
...
CORS_ALLOW_ALL_ORIGINS = True  # Allow all origins to access the backend
